        ...
        methods:{
            fetchAllAds(){
                ...
                .then(res => {
                    ...
                    var table = $('#allAdsTable').DataTable();
            ...
            addPost(){
                ...
                axios.post('http://localhost:8000/api/create_ad', this.add)
                .then(res => {
                    if(res.status == 201){
                        location.reload();
                    }
            ...
            editPost(id){
                axios.get('http://localhost:8000/api/single_ad/'+id)
                .then(res => {
            ...
            updatePost(){
                axios.put('http://localhost:8000/api/update_ad/' + this.add.id, this.add)
                .then(res => {
                    if(res.status == 200){
                        location.reload();
                    }
            ...
            activation(id){
                ...
                .then(res => {
                    ...
                    ad_name = res.data.data.ad_name;
                    ad_caption = res.data.data.ad_caption;
                    ad_duration = res.data.data.ad_duration;
                    visual_identity = res.data.data.visual_identity;
