            ...
            <div class="modal-dialog modal-lg modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-sm-2">AD.Client</div>
                            <div class="col-sm-10">
                            ...
                            <div class="col-sm-2 mt-3">Reference No</div>
                            <div class="col-sm-10 mt-3">
        ...
        methods:{
            fetchAdClient(){
                ...
                .then(res => {
                    ...
                    var table = $('#adClientTable').DataTable();
            ...
            addPost(){
                ...
                axios.post('http://localhost:8000/api/create_ad_client', this.add)
                .then(res => {
                    if(res.status == 201){
                        //this.add.floor_name == "";
            ...
            editPost(id){
                axios.get('http://localhost:8000/api/single_ad_client/'+id)
                .then(res => {
                    ...
                    this.add.reference_no = res.data.data.reference_no,
            ...
            updatePost(){
                axios.put('http://localhost:8000/api/update_ad_client/' + this.add.id, this.add)
                .then(res => {
                    if(res.status == 200){
                        location.reload();
                    }
            ...
            deletePost(id){
                ...
                console.log(id);
                axios.delete('http://localhost:8000/api/ad_clients/'+id)
                .then(res => {
