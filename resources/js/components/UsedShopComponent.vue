<template>
    <div class="container mt-5">
        ...
        <div class="d-flex justify-content-end">
            <Button class="btn btn-success mb-5" data-toggle="modal" data-target="#addPostModal">Create Used Shop</Button>
        </div>
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="table-responsive">
                    <table id="usedShopTable" class="table table-striped" style="width:100%">
                        <thead>
                            <tr>
                                <th>ID</th>
                                <th>Image</th>
        ...
        <div class="modal fade" id="addPostModal">
            <div class="modal-dialog modal-lg modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <h4 class="modal-title">Create Used Shop for GSM</h4>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-sm-3 mt-3">Client</div>
        ...
        <div class="modal fade" id="editPostModal">
            <div class="modal-dialog modal-lg modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <!-- Modal Header -->
                    <div class="modal-header">
                    <h4 class="modal-title">Edit Used Shop for GSM</h4>
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    </div>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-sm-9 mt-3">
                                <div class="form-check-inline">
                                    <label class="form-check-label">
                                        <input type="checkbox" class="form-check-input" name="addradio" v-bind:value="1" v-model="add.free_shipping_for_all"><span><strong>Free Shipping for All Product</strong></span>
                                    </label>
                                </div>
                            </div>
                        </div>
...
<script>
    export default {
        ...
        methods:{
            ...
            fetchUsedShop(){
                axios.get('http://localhost:8000/api/used_shops')
                .then(res => {
                    this.list = res.data;
                }).then(res => {
                    $("#usedShopTable").DataTable({
                    ...
                    var table = $('#usedShopTable').DataTable();
            ...
            addPost(){
                if(this.add.file == '' || this.add.client_name == '' || this.add.merchant == '' || this.add.brand == '' || this.add.category == '' || this.add.floor == '' || this.add.mall == '' || this.add.selling_identity == '' || this.add.city == '' || this.add.free_shipping_min_amount == ''){
                ...
                axios.post('http://localhost:8000/api/create_used_shop', formData,
                    {
                        headers: {
            ...
            editPost(id){
                axios.get('http://localhost:8000/api/single_used_shop/'+id)
                .then(res => {
            ...
            updatePost(){
                axios.put('http://localhost:8000/api/update_used_shop/' + this.add.id, this.add)
                .then(res => {
                    if(res.status == 200){
                        location.reload();
                    }
            ...
            activation(id){
                ...
                .then(res => {
                    axios.put('http://localhost:8000/api/update_used_shop/' + id, {client_name:client_name, merchant:merchant, brand:brand, category:category, floor:floor, mall:mall, selling_identity:selling_identity, city:city, free_shipping_min_amount:free_shipping_min_amount, free_shipping_for_all:free_shipping_for_all, activation: activationCode}).then(res => {location.reload();}).catch(err => {console.log("Error = "+err);})
                }).catch(err => {console.log("Error = "+err);})
                .catch(err => {console.log("Error = "+err);})
            },
            deletePost(id){
                axios.delete('http://localhost:8000/api/used_shops/'+id)
                .then(res => {
