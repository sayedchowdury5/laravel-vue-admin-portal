<template>
    <div class="container mt-5">
        ...
        <div class="d-flex justify-content-end">
            <Button class="btn btn-success mb-5" data-toggle="modal" data-target="#addPostModal">Create Othermall New</Button>
        </div>
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="table-responsive">
                    <table id="otherMallTable" class="table table-striped" style="width:100%">
                        <thead>
                            <tr>
                                <th>ID</th>
                                <th>Image</th>
...
<script>
    export default {
        ...
        methods:{
            ...
            fetchOtherMallShop(){
                axios.get('http://localhost:8000/api/other_malls')
                .then(res => {
                    this.list = res.data;
                }).then(res => {
                    $("#otherMallTable").DataTable({
                    ...
                    var table = $('#otherMallTable').DataTable();
            ...
            addPost(){
                ...
                axios.post('http://localhost:8000/api/create_other_mall', formData,
                    {
                        headers: {
            ...
            editPost(id){
                axios.get('http://localhost:8000/api/single_other_mall/'+id)
                .then(res => {
            ...
            updatePost(){
                axios.put('http://localhost:8000/api/update_other_mall/' + this.add.id, this.add)
                .then(res => {
                    if(res.status == 200){
                        location.reload();
                    }
            ...
            activation(id){
                ...
                .then(res => {
                    axios.put('http://localhost:8000/api/update_other_mall/' + id, {shop_name:shop_name, merchant:merchant, brand:brand, category:category, floor:floor, mall:mall, selling_identity:selling_identity, city:city, free_shipping_min_amount:free_shipping_min_amount, free_shipping_for_all:free_shipping_for_all, activation: activationCode}).then(res => {location.reload();}).catch(err => {console.log("Error = "+err);})
                }).catch(err => {console.log("Error = "+err);})
                .catch(err => {console.log("Error = "+err);})
            },
            deletePost(id){
                axios.delete('http://localhost:8000/api/other_malls/'+id)
                .then(res => {
