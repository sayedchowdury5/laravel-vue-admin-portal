        ...
        <div id="wrapper">
          ...
          <nav class="navbar navbar-inverse fixed-top" id="sidebar-wrapper" role="navigation">
            ...
            <ul class="navbar-nav sidebar-nav">
              ...
              <li class="nav-item">
                <a class="nav-link" href="{{url('/')}}"> <i class="fa fa-home ml-2"></i> Dashboard</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="{{url('/')}}"><i class="fa fa-home ml-2"></i> Floor</a>
              </li>
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu animated fadeInLeft" role="menu">
                  ...
                  <li class="nav-item">
                    <a class="nav-link ml-2" href="{{url('/products-category')}}"> Category</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link ml-2" href="{{url('/products')}}"> Product</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link ml-2" href="{{url('/brand')}}">Brand</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link ml-2" href="{{url('/sub-brand')}}"> Sub Brand</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link ml-2" href="{{url('/sub-brand-details')}}">Sub Brand (Details)</a>
                  </li>
                </ul>
              </li>
              <li class="nav-item">
                <a class="nav-link ml-2" href="{{url('/mall')}}"><i class="fa fa-home"></i> Mall</a>
              </li>
              <li class="nav-item">
                <a class="nav-link ml-2" href="{{url('/merchant')}}"><i class="fa fa-home"></i> Merchant</a>
              </li>
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu animated fadeInLeft" role="menu">
                  ...
                  <li class="nav-item">
                    <a class="nav-link ml-2" href="{{url('/selling-identity')}}"> Selling Identity</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link ml-2" href="{{url('/new-shop')}}"> GSM New</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link ml-2" href="{{url('/used-shop')}}"> GSM Used</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link ml-2" href="{{url('/other-mall-shop')}}"> Othermall</a>
                  </li>
                </ul>
              </li>
              <li class="nav-item dropdown">
              ...
              <li class="nav-item">
                <a class="nav-link ml-2" href="{{url('/voucher')}}"><i class="fa fa-user"></i> Voucher</a>
              </li>
              <li class="nav-item">
                <a class="nav-link ml-2" href="{{url('/promotion-update')}}"><i class="fa fa-user"></i> Promotion / Updates</a>
              </li>
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu animated fadeInLeft" role="menu">
                  ...
                  <li class="nav-item">
                    <a class="nav-link ml-2" href="{{url('/ad-client')}}"> Create AD Client</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link ml-2" href="{{url('/create-ads')}}"> Create AD</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link ml-2" href="{{url('/ad-schedule')}}"> AD Schedule</a>
                  </li>
                </ul>
              </li>
              <li class="nav-item">
                <a class="nav-link ml-2" href="{{url('/logistic')}}"><i class="fa fa-user"></i> Logistic</a>
              </li>
              <li class="nav-item">
              ...
              <li class="nav-item">
                <a class="nav-link ml-2" href="{{url('/manage-admin')}}"><i class="fa fa-home"></i> Manage Admin</a>
              </li>
              <li class="nav-item dropdown">
          ...
          <div class="container-fluid" id="page-content-wrapper">
            <div class="d-flex">
                ...
                <div class="mt-2" style="margin-left: 100px;">
                    <img src="https://thegreen.studio/images/gsm.png" alt="GSM Logo" width="80%" height="70%">
                </div>
                <div class="ml-auto">
                  <h5 class="mt-3 ml-auto"><strong>Admin Name <i class="fa fa-user" style="font-size:30px;"></i></strong></h5>
                </div>
            </div>
            <!-- <div class="">
                @yield('content')
